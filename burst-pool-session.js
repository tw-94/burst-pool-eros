...
function getWalletUrl() {
    if (count == 0) {
        ...
        return config.wallets2[0].walletUrl + '/burst';
    }
}
...
function checkWallets() {
    request.post({
        url: config.wallets[0].walletUrl + '/burst',
        form: {
    ...
    request.post({
        url: config.wallets2[0].walletUrl + '/burst',
        form: {
            requestType: 'getBlock',
        }
    },
    ...
    //Check Block Height
    if(wallet8125 > wallet8126) {
      count = 0;
      //console.log(wallet8125 + " --- " + wallet8126);
    } else {
      count = 1;
      //console.log(wallet8125 + " --- " + wallet8126);
    }
}
function getWalletInd() {
  return count;
}
